...
export function SeatingArrangement({
  ...
  // NEW: Get highlighted guest name
  const highlightedGuest = highlightedGuestId
    ? unassignedGuests.find((g) => g.id === highlightedGuestId)
    : null;

  return (
    <div className="space-y-6">
      {/* NEW: Highlighted Guest Banner */}
      {highlightedGuest && (
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <h4 className="font-medium text-blue-900">
                  Assigning: {highlightedGuest.guestName}
                </h4>
                <p className="text-sm text-blue-700">
                  Click any available seat below to assign this guest
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <div className="flex items-center gap-2">
          ...
          {unassignedGuests.length > 0 && (
            <Button
              ...
              disabled={
                loading || stats.availableSeats < unassignedGuests.length
              }
              className="gap-2"
            >
                    ...
                    {table.seats.map((seat: any) => (
                      <div
                        ...
                        className={`flex items-center justify-between p-2 border rounded hover:bg-accent cursor-pointer ${
                          !seat.invitation && highlightedGuestId
